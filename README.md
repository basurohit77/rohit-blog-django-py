...
```
oc new-app basurohit77/rohit-blog-django-py --name blog-from-image
...
```
oc new-app python:latest~https://github.com/basurohit77/rohit-blog-django-py --name blog-from-source-py
...
```
oc new-app --strategy=source https://github.com/basurohit77/rohit-blog-django-py --name blog-from-source-auto
...
```
oc new-app https://github.com/basurohit77/rohit-blog-django-py --name blog-from-docker
